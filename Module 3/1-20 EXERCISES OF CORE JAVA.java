...
public class DataTypes {
    public static void main(String[] args) {
        ...
        System.out.printf("int: %d%nfloat: %.2f%ndouble: %.5f%nchar: %c%nboolean: %b%n", i, f, d, c, b);
    }
}
...
public class OperatorPrecedence {
    public static void main(String[] args) {
        int result = 10 + 5 * 2;
        System.out.println("Result: " + result); // Should print 20
    }
}
...
class Car {
    ...
    void displayDetails() {
        System.out.printf("Make: %s, Model: %s, Year: %d%n", make, model, year);
    }
